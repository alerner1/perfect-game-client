            ...
            <Form.Group as={Row}>
              {this.state.allPlatforms ?
                <>
                  ...
                  <Col xs={3}><Form.Check disabled inline label='PlayStation 5' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[3]}`} value={default_platforms[3]} /></Col>
                  <Col xs={3}><Form.Check disabled inline label='Xbox One' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[4]}`} value={default_platforms[4]} /></Col>
                  <Col xs={3}><Form.Check disabled inline label='Xbox Series X' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[5]}`} value={default_platforms[5]} /></Col>
                </>
                :
                <>
                  ...
                  <Col xs={3}><Form.Check inline label='PlayStation 5' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[3]}`} value={default_platforms[3]} /></Col>
                  <Col xs={3}><Form.Check inline label='Xbox One' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[4]}`} value={default_platforms[4]} /></Col>
                  <Col xs={3}><Form.Check inline label='Xbox Series X' onClick={this.handleChange} name="platform" type='checkbox' id={`inline-checkbox-${default_platforms[5]}`} value={default_platforms[5]} /></Col>
                </>
              }
